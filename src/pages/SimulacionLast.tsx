...
const Simulacion = () => {
  ...
  const agentIdByScenario: { [key: string]: string } = {
    ...
    //"agent_9601kbjcvg6vfzbbqpqhx43nf2xm",
    casual: "agent_4501kbk0dergefs9k5d13c3sw9ec",
    //casual: "agent_3601kbjzsz0cf2g9sjq7ajnpypyw",
    presentacion: "agent_6801kbk0hk9vfgetkh6wch4nj2ca"
    //presentacion: "agent_0101kbjzx2bsech9nmcmvcn0e7w6"
  ...
  const handleStart = () => {
    ...
    startSession(
      {
        agentId: agentIdByScenario[tipo as keyof typeof agentIdByScenario] || "agent_3001kazqvrppejmaazabtnj6vv87",
        //"agent_5601kayt31j1ehfsxze75ygb4e2r",
        //import.meta.env.ELEVENLABS_AGENT_ID!,
